    ...
    register: function register() {
      ...
      this.$store.dispatch('REGISTER', {
        ...
        if (error.response.status === 422) {
          console.log("ERRRR:: ", error.response.data); // this.errors = error.response.data.errors;
        }
      });
    }
  }
...
var render = function() {
  ...
  return _c("div", { staticClass: "login" }, [
    _c("div", { staticClass: "login-triangle" }),
    _vm._v(" "),
    _c("h2", { staticClass: "login-header" }, [_vm._v("Register")]),
    _vm._v(" "),
    _c(
      "form",
      {
